...
Revision ID: 652cbe3d1506
Revises: 
Create Date: 2025-11-05 11:44:03.124727
...
def upgrade():
    ...
    sa.Column('remarks', sa.Text(), server_default=sa.text("''::character varying"), nullable=False),
