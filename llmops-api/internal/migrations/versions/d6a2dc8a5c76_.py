...
Revision ID: d6a2dc8a5c76
Revises: da77a9ec6895
Create Date: 2026-02-02 11:26:37.475102
...
revision = 'd6a2dc8a5c76'
down_revision = 'da77a9ec6895'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('app', schema=None) as batch_op:
        batch_op.add_column(sa.Column('remarks', sa.TEXT(), server_default=sa.text("''::character varying"), autoincrement=False, nullable=False))
